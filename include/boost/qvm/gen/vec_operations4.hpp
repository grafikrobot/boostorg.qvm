...
operator+( A const & a, B const & b )
    ...
    R r;
    write_vector_element<0>(r,vec_traits<A>::template read_element<0>(a)+vec_traits<B>::template read_element<0>(b));
    write_vector_element<1>(r,vec_traits<A>::template read_element<1>(a)+vec_traits<B>::template read_element<1>(b));
    write_vector_element<2>(r,vec_traits<A>::template read_element<2>(a)+vec_traits<B>::template read_element<2>(b));
    write_vector_element<3>(r,vec_traits<A>::template read_element<3>(a)+vec_traits<B>::template read_element<3>(b));
    return r;
    }
...
operator+=( A & a, B const & b )
    {
    write_vector_element<0>(a,vec_traits<A>::template read_element<0>(a)+vec_traits<B>::template read_element<0>(b));
    write_vector_element<1>(a,vec_traits<A>::template read_element<1>(a)+vec_traits<B>::template read_element<1>(b));
    write_vector_element<2>(a,vec_traits<A>::template read_element<2>(a)+vec_traits<B>::template read_element<2>(b));
    write_vector_element<3>(a,vec_traits<A>::template read_element<3>(a)+vec_traits<B>::template read_element<3>(b));
    return a;
    }
...
operator*( A const & a, B b )
    ...
    R r;
    write_vector_element<0>(r,vec_traits<A>::template read_element<0>(a)*b);
    write_vector_element<1>(r,vec_traits<A>::template read_element<1>(a)*b);
    write_vector_element<2>(r,vec_traits<A>::template read_element<2>(a)*b);
    write_vector_element<3>(r,vec_traits<A>::template read_element<3>(a)*b);
    return r;
    }
...
operator*( A a, B const & b )
    ...
    R r;
    write_vector_element<0>(r,a*vec_traits<B>::template read_element<0>(b));
    write_vector_element<1>(r,a*vec_traits<B>::template read_element<1>(b));
    write_vector_element<2>(r,a*vec_traits<B>::template read_element<2>(b));
    write_vector_element<3>(r,a*vec_traits<B>::template read_element<3>(b));
    return r;
    }
...
operator*=( A & a, B b )
    {
    write_vector_element<0>(a, vec_traits<A>::template read_element<0>(a)*b);
    write_vector_element<1>(a, vec_traits<A>::template read_element<1>(a)*b);
    write_vector_element<2>(a, vec_traits<A>::template read_element<2>(a)*b);
    write_vector_element<3>(a, vec_traits<A>::template read_element<3>(a)*b);
    return a;
    }
...
convert_to( A const & a )
    {
    R r;
    write_vector_element<0>(r,vec_traits<A>::template read_element<0>(a));
    write_vector_element<1>(r,vec_traits<A>::template read_element<1>(a));
    write_vector_element<2>(r,vec_traits<A>::template read_element<2>(a));
    write_vector_element<3>(r,vec_traits<A>::template read_element<3>(a));
    return r;
    }
...
normalized( A const & a )
    ...
    typedef typename deduce_vec<A>::type R;
    R r;
    write_vector_element<0>(r,a0*rm);
    write_vector_element<1>(r,a1*rm);
    write_vector_element<2>(r,a2*rm);
    write_vector_element<3>(r,a3*rm);
    return r;
    }
...
normalize( A & a )
    ...
    if( m2==scalar_traits<typename vec_traits<A>::scalar_type>::value(0) )
        BOOST_QVM_THROW_EXCEPTION(zero_magnitude_error());
    T const rm=scalar_traits<T>::value(1)/sqrt(m2);
    write_vector_element<0>(a,vec_traits<A>::template read_element<0>(a)*rm);
    write_vector_element<1>(a,vec_traits<A>::template read_element<1>(a)*rm);
    write_vector_element<2>(a,vec_traits<A>::template read_element<2>(a)*rm);
    write_vector_element<3>(a,vec_traits<A>::template read_element<3>(a)*rm);
    }
